...
<div>
  {
user?._id ? (
<button  onClick={handlelogout} className='px-3 py-2 bg-pink-600 text-white rounded-full hover:bg-pink-700'>Logout</button>

)
:(
  <Link to="/login" className='px-3 py-2 bg-pink-600 text-white rounded-full hover:bg-pink-700'> Login</Link>
